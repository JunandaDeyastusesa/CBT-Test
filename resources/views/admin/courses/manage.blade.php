            ...
            <div id="course-test" class="mx-[70px] w-[870px] mt-[30px]">
                ...
                <div class="flex flex-col gap-[30px] mt-2">
                    ...
                    <div class="flex items-center gap-4 mb-4">
                        <!-- Menampilkan nomer question di luar card -->
                        <div class="text-xl font-bold shrink-0">{{$question->number}}.</div>
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-[6px]">
                                ...
                                <!-- Menampilkan pratinjau gambar (image) -->
                                <div id="image-preview-{{$i}}"
                                    class="relative w-[100px] h-[100px] overflow-hidden peer-data-[empty=true]:border-[3px] peer-data-[empty=true]:border-dashed peer-data-[empty=true]:border-[#EEEEEE]">
